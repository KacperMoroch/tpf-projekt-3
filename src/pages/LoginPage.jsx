...
const Login = () => {
    ...
    const handleGuestLogin = async () => {
        ...
        try {
            ...
            console.log('Zalogowano pomyślnie jako gość!', userCredential.user);
            navigate('/lodowka');
        } catch (error) {
            console.error('Błąd logowania jako gość:', error);
            setError("Nie udało się wejść jako gość. Spróbuj ponownie.");
        }
    };
    ...
    return (
        <div className="login-container">
            ...
            <button type="button" className="login-guest-link" onClick={handleGuestLogin}>
